...
面向小米 17（pudding）HyperOS 的 KernelSU 日志降噪模块。主要目标是让 logcat 更容易阅读，同时减少低价值日志进入缓冲区的开销；不承诺续航或性能提升。
...
目前的规则依据来自小米 17 pudding、Android 17、HyperOS 4 与 KernelSU 3.3 环境的有限采样。
